# OSS-Audit- 24BAI10478

This is my Open Source Software lab repo for auditing **Git** on **Arch linux**.

I’m **palak** (`palak`, reg no `24BAI10478`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
- `manifesto_om.txt` - Example output from the manifesto generator

## How to run the scripts

From the repo directory (`/home/om/oss-audit-24BAI10478`):
